...
public class RandomGen {
     ...
     */
    public RandomGen(final int setBlockSize, final char[] tokenList) throws Exception {
        if (setBlockSize > 16) {
     ...
     * @throws Exception if block size is too big
     */
    public static RandomGen createWithDefaultTokens(final int setBlockSize) throws Exception {
        ...
        return new RandomGen(setBlockSize, tokens);
    }
